...
extern const unsigned char BMP1[]; // 声明 BMP1 的存在
extern const unsigned char BMP2[]; // 声明 BMP2 的存在
extern const unsigned char BMP3[]; // 声明 BMP3 的存在
extern const unsigned char BMP4[]; // 声明 BMP4 的存在
extern const unsigned char BMP5[]; // 声明 BMP5 的存在
