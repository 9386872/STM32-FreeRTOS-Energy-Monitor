...
extern osThreadId_t menuHandle;
extern osThreadId_t buttonHandle;
extern osMutexId_t   ElectricDataMutexHandle;
extern osMessageQueueId_t EspRxQueueHandle;
extern osThreadId_t CollectionHandle;
